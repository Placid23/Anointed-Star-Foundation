...
const COOKIE_CONSENT_KEY = 'anointed_foundation_cookie_consent';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-grow">
          ...
          <AlertDescription className="text-sm text-card-foreground/80 mt-1">
            We use cookies to enhance your browsing experience, analyze site traffic, and personalize content for Anointed Foundation. By clicking &quot;Accept&quot;, you consent to our use of cookies.
          </AlertDescription>
        </div>
